...
@section('title','Contractor Signup')
@section('content')
        ...
        <div class="login_inputs">
            ...
            <div class="tab-content custom_tabcontent" id="myTabContent">
                <div class="tab-pane fade show active" id="signin" role="tabpanel" aria-labelledby="signin-tab">
                    <div class="contractor_logintitle">Contractor Login</div>
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="forgot_pwd_div">
                            <div class="forgot_pwd_left">
                                <a class="login_buyer_a" href="{{ route('register') }}">Login as Buyer</a>
                                <a class="login_vendor_a" href="{{ route('vendor.signup') }}">Login as Vendor</a>
                            </div>
                ...
                <div class="tab-pane fade" id="signup" role="tabpanel" aria-labelledby="signup-tab">
                    <div class="contractor_logintitle">Contractor Sign Up</div>
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="forgot_pwd_div">
                            <div class="forgot_pwd_left">
                                <a class="login_buyer_a" href="{{ route('register') }}">Sign Up as Buyer</a>
                                <a class="login_vendor_a" href="{{ route('vendor.signup') }}">Sign Up as Vendor</a>
                            </div>
                        </div>
                        <div class="signin_btn_outer">
                            <button type="submit" class="signin_a">
